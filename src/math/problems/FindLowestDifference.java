...
public class FindLowestDifference {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println("The lowest difference between in both arrays is"
                +FindLowestDifference(array1,array2,num1,num2));
    ...
    static int FindLowestDifference(int array1[],int array2[], int num1,int num2){
        ...
        int finalSolution = Integer.MAX_VALUE;
        while(temp1<num1 && temp2<temp2){
